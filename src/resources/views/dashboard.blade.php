...
@section('content')
    <div class="py-12">
        ...
        @else
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div
                    ...
                    <p class="text-[10px] font-medium text-brand-medium/60 italic leading-tight uppercase tracking-wide">
                        Permanent score based on your financial behavior (CDC Rule 5.5).
                    </p>
                </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach ($membership->colocation->memberships as $member)
                                <div
                                    class="p-6 bg-white rounded-[2rem] border border-brand-light/10 flex items-center justify-between shadow-sm group hover:border-brand-medium/30 transition-all hover:shadow-md">
                                    <div class="flex items-center gap-5">
                                        <div
                                            class="w-14 h-14 rounded-2xl bg-brand-soft flex items-center justify-center font-black text-brand-dark text-lg border border-brand-light/20 shadow-inner group-hover:bg-brand-dark group-hover:text-white transition-all duration-300">
            ...
            <!-- MEMBERSHIP MANAGEMENT (owwners cannot leave) -->
            @if (!$membership->is_owner)
                <div class="mt-20 pt-10 border-t border-brand-light/20 text-center">
                    <form action="{{ route('colocations.leave') }}" method="POST"
                        onsubmit="return confirm('Are you sure you want to exit this house?');">
                        @csrf
                        <button type="submit"
                            class="group inline-flex flex-col items-center gap-3">
                            <span class="text-[10px] font-black text-red-500/40 group-hover:text-red-600 uppercase tracking-[0.4em] transition-all">
